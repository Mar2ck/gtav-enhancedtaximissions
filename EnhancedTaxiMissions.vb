...
Public Class EnhancedTaxiMissions
    ...
    Public Sub LoadSettings()
        ...
        value = Settings.GetValue("SETTINGS", "HAZARDLIGHTS")
        If value = 1 Then
    ...
    Public Sub refreshUI()
        ...
        If Game.Player.Character.IsInVehicle = True Then
            ...
            ElseIf Game.Player.Character.CurrentVehicle.DisplayName = "STRETCH" Then
                headerText = "Limousine Driver"
            Else
                headerText = "Ride Share Driver"
            End If
        Else
        ...
        If ShowDebugInfo = True Then
            ...
            Dim DebugTextFields As New List(Of String)

            DebugTextFields.Add("-- DEBUG INFORMATION --")
            DebugTextFields.Add("Game Stage: " & MiniGameStage.ToString)
            DebugTextFields.Add("Current Day Time: " & World.CurrentDayTime.TotalSeconds & " (" & Math.Round(100 * (World.CurrentDayTime.TotalSeconds / 86400)) & "%)")
            DebugTextFields.Add("GameTime: " & (Game.GameTime / 1000).ToString("#,###,###.###") & " seconds")
    ...
    Public Sub checkVehicleBoardingCondition()
        ...
        If Game.Player.Character.IsInVehicle Then
            ...
            If Game.Player.Character.CurrentVehicle.DirtLevel > 20 And ClosestPedDistance < 3 Then
                ...
                Dim messageText = "VEHICLE TOO DIRTY!"
            ...
            If VehicleStartHealthPercent < 0.75 And ClosestPedDistance < 4 Then
                Dim messageText = "VEHICLE TOO DAMAGED!"
    ...
    Private Sub SelectValidOrigin(Places As List(Of Location))
        ...
        Dim SelectedOrigins As New List(Of Location)
...
'TO-DO LIST
'CONFIRM BEFORE ENDING MISSION
'EXPAND TIP PAY
'   based on driving style & vehicle condition
'   Occasional passenger who skips out and doesn't pay fare
'EVALUATE:
'   DRIVING STYLE
'      -> CONFIGURABLE
